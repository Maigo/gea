...
public:
    ...
    // constructors
    inline polar3();
    inline polar3(float r, float theta, float phi);
    ...
    inline const polar3 operator- (const polar3 &o) const;
	inline const polar3 operator* (float s) const;
	inline const polar3 operator/ (float s) const;
	
    // compound assignment
    inline polar3 &operator+= (const polar3 &o);
    inline polar3 &operator-= (const polar3 &o);
    inline polar3 &operator*= (float s);
    inline polar3 &operator/= (float s);

    // comparative
	inline bool operator== (const polar3 &o) const;
	inline bool operator!= (const polar3 &o) const;
	inline bool operator<  (const polar3 &o) const;
	inline bool operator<= (const polar3 &o) const;
	inline bool operator>  (const polar3 &o) const;
    ...
    void to_vector(vector3 &v) const;
};
