...
// ------------------------------------------------------------------------- //
void encode_s3(const quaternion &q, quaternion_c32 &cq) {
...
void decode_s3(const quaternion_c32 &cq, quaternion &q) {
    // decode
    ...
    switch (lc) {
    case 0: q.x = c0; q.y = c1; q.z = c2; q.w = c3; break;
    case 1: q.x = c1; q.y = c0; q.z = c2; q.w = c3; break;
    case 2: q.x = c1; q.y = c2; q.z = c0; q.w = c3; break;
    case 3: q.x = c1; q.y = c2; q.z = c3; q.w = c0; break;
    default:                                        break;
    }
}
...
void encode_polar(const quaternion &q, quaternion_c32 &cq) {
    ...
    // get rotation axis
    float angle;
    vector3 v(mth::SKIP_INITIALIZATION);
    q.to_axis(angle, v);
...
void decode_polar(const quaternion_c32 &cq, quaternion &q) {
    ...
    q.x = r*v.x, q.y = r*v.y, q.z = r*v.z, q.w = w;
}
