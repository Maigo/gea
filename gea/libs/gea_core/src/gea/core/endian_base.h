...
template <typename T>
__forceinline void endian_swap(T& value) {
...
template <int N>
__forceinline void endian_swap_intrinsic(void* value);

// use intrinsic byte swaps if supported by target platform
#if defined(INTRINSIC_BYTE_SWAP)
template <> __forceinline void endian_swap_intrinsic<1>(void* value) {}
template <> __forceinline void endian_swap_intrinsic<2>(void* value) {
    byte_swap16( *((uint16_t*)value) );
}
template <> __forceinline void endian_swap_intrinsic<4>(void* value) {
    byte_swap32( *((uint32_t*)value) );
}
template <> __forceinline void endian_swap_intrinsic<8>(void* value) {
    byte_swap64( *((uint64_t*)value) );
}
// otherwise use custom bitshift implementation
#else // not INTRINSIC_BYTE_SWAP
template <>
__forceinline void endian_swap_intrinsic<1>(void* value) {}
template <>
__forceinline void endian_swap_intrinsic<2>(void* value) {
    *((uint16_t*)value) = ( (*((uint16_t*)value) & 0xFF00) >> 8 )
                        | ( (*((uint16_t*)value) & 0x00FF) << 8 );
}
template <>
__forceinline void endian_swap_intrinsic<4>(void* value) {
...
template <>
__forceinline void endian_swap_intrinsic<8>(void* value) {
