...
inline const size_t hex_to_dec(const char *hex, const size_t hex_size, uint16_t &out_dec) {
    uint8_t hi, lo;
...
inline const size_t hex_to_dec(const char *hex, const size_t hex_size, uint32_t &out_dec) {
    uint16_t hi, lo;
    const size_t hi_shift = hex_to_dec(hex + 0, hex_size, hi);
...
inline const size_t hex_to_dec(const char *hex, const size_t hex_size, uint64_t &out_dec) {
    uint32_t hi, lo;
    const size_t hi_shift = hex_to_dec(hex + 0, hex_size, hi);
